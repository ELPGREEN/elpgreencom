...
export function FeasibilityStudyCalculator() {
  ...
  const qrCodeFormOptions = [
    ...
    { value: 'template-kyc', label: t('admin.feasibility.qrForms.dueDiligenceChecklist', 'Due Diligence Checklist (KYC)'), url: `${siteBaseUrl}/documents/template/a1b2c3d4-e5f6-7890-abcd-111111111111?source=pdf_feasibility` },
    { value: 'template-loi', label: t('admin.feasibility.qrForms.loi', 'Letter of Intent (LOI)'), url: `${siteBaseUrl}/documents/template/b2c3d4e5-f6a7-8901-bcde-222222222222?source=pdf_feasibility` },
    { value: 'template-mou', label: t('admin.feasibility.qrForms.mou', 'Memorandum of Understanding (MOU)'), url: `${siteBaseUrl}/documents/template/c3d4e5f6-a7b8-9012-cdef-333333333333?source=pdf_feasibility` },
